...
- `assets/img/` — optimized artwork extracted from the Canva export (key art, team illustrations, arrows, brackets, brush, paw, speech bubble, logos, background texture).
