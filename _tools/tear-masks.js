...
(function (root) {
  ...
  function dotSvg(p, frame) {
    var o = p.shapes.dot;
    var f = turb({ freq: [0.09, 0.09], octaves: 1 }, false, p.boil.seeds[frame], 'w') +
